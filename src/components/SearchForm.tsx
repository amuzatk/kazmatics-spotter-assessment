...
import { cabinOptions, tripOptions } from "../data/data";
      ...
      <div className="w-full  mb-6 flex flex-col  ">
        ...
        <div>
          {tripType === "multicity" && (
            <button
              onClick={addFlight}
              className="flex w-full md:w-auto items-center md:items-start justify-center  px-6 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-medium rounded-[30px] shadow-lg transition-colors"
            >
...
//// broken into reusable components
// import React, { useState, useRef, useEffect } from "react";
// import { Airport, SearchParams, FlightLeg } from "../types/flight";
// import { FlightApiService } from "../services/flightApi";
// import PassengerSelector from "./PassengerSelector";
// import TripTypePassengerClass from "./TripTypePassengerClass";
// import ExploreButton from "./ExploreButton";
// import FlightLegs from "./FlightLeg";
...
//   const [legs, setLegs] = useState<FlightLeg[]>([
//     { origin: "", destination: "", date: "", returnDate: undefined },
//   ]);
//   const [returnDate, setReturnDate] = useState("");
//   const [passengers, setPassengers] = useState({
//     adults: 1,
...
//     searchTimeoutRef.current = setTimeout(() => searchAirports(query), 300);
//   };
...
//     setAirportSearchResults([]);
//     const key = `${index}-${field}`;
//     setAirportSearchQuery((prev) => ({ ...prev, [key]: airport.navigation.relevantFlightParams.skyId }));
//   };
...
//   const addFlight = () => {
//     setLegs([...legs, { origin: "", destination: "", date: "", returnDate: undefined }]);
//   };
...
//   return (
//     <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mx-auto relative">
//       <TripTypePassengerClass
//         tripType={tripType}
//         setTripType={setTripType}
//         passengers={passengers}
//         setIsPassengerModalOpen={setIsPassengerModalOpen}
...
//         showTripDropdown={showTripDropdown}
//         setShowTripDropdown={setShowTripDropdown}
//         showCabinDropdown={showCabinDropdown}
//         setShowCabinDropdown={setShowCabinDropdown}
...
//         airportSearchQuery={airportSearchQuery}
...
//       <ExploreButton
//         onClick={handleSearch}
//         disabled={loading || !legs[0].origin || !legs[0].destination || !legs[0].date}
//         loading={loading}
//       />
//     </div>
//   );
