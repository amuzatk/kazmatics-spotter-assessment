...
// import { Clock, Plane, ArrowRight, ChevronDown, ChevronUp } from 'lucide-react';
...
const FlightResults: React.FC<FlightResultsProps> = ({
  ...
  const toggleFlightExpansion = (flightId: string) => {
    ...
    newExpanded.has(flightId) ? newExpanded.delete(flightId) : newExpanded.add(flightId);
...
//       default:
//         return 0; // Keep original order for 'best'
//     }
//   });
...
//                               </div>
//                               <div className="mt-1 text-xs text-gray-400">
//                                 {leg.segments.length > 1 ? `${leg.segments.length - 1} stop${leg.segments.length > 2 ? 's' : ''}` : 'Nonstop'}
//                               </div>
//                             </div>
...
//                           <div className="mt-2 text-sm text-gray-600 dark:text-gray-400">
//                             {leg.carriers.map((carrier, index) => (
//                               <span key={index}>
//                                 {carrier.name}
//                                 {index < leg.carriers.length - 1 && ', '}
//                               </span>
//                             ))}
//                           </div>
//                         </div>
...
//                       <div key={legIndex} className="space-y-3">
//                         {leg.segments.map((segment, segmentIndex) => (
//                           <div key={segmentIndex} className="flex items-center space-x-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
//                             <div className="text-sm">
//                               <div className="font-medium text-gray-900 dark:text-white">
